...
from database import get_connection, create_table, register_user, get_users,get_users_by_id, update_user
...
def edit_user():
    ...
    update_user(id, nome, email, senha)
